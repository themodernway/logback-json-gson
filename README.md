The Modern Way - Logback JSON Gson
======
...
```
dependencies {
    compile(group: 'com.themodernway', name: 'logback-json-gson', version: '2.0.17-SNAPSHOT')
}
```
Javadoc URL:
...
![alt SonarQube](https://sonarcloud.io/api/project_badges/quality_gate?project=com.themodernway%3Alogback-json-gson "SonarQube")
